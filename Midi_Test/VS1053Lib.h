...
#define VS1053_RESET			(_BV(PINA0))
#define VS1053_DREQ()			(bit_is_set(PINA,PINA1))
#define VS1053_CS				(_BV(PINA2))
#define VS1053_DCS				(_BV(PINA3))
//#define VS1053_GPIO0			(_BV(PINA4))
//#define VS1053_GPIO1			(_BV(PINA5))


#define VS1053_RESET_LOW()		(PORTA &= ~VS1053_RESET)
#define VS1053_RESET_HI()		(PORTA |= VS1053_RESET)

#define VS1053_CS_LOW()			(PORTA &= ~VS1053_CS)
#define VS1053_CS_HI()			(PORTA |= VS1053_CS)

#define VS1053_DCS_LOW()		(PORTA &= ~VS1053_DCS)
#define VS1053_DCS_HI()			(PORTA |= VS1053_DCS)
...
void memory_test_();
//void VLSI_Mp3Test(void);


//static unsigned char HelloMP3[] = {
